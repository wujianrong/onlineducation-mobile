<template>
	<div>
		...
		<div class="class_content" v-if="data_class.type == '免费课程'">
			...
			<div class="class_content_top_gl" v-for="item,key in data_class.sections" v-if="key < datalength" :key="key" @click="show_class(item)">
				...
				<div class="class_content_right right">
					<div class="left width80">
						...
						<span class="class_content_time">{{item.video.duration}}</span>
					</div>
				</div>
				<div class="clear"></div>
			</div>
